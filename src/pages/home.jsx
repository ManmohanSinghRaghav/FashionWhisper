export default function Home() {
  return (
    <div className="fixed flex justify-center items-center w-full h-full bg-gray-900">
      <section className="w-1/2 p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800">
